...
class BaselineType(StrEnum):
    ...
    ML_ONLY = "ML_ONLY"
    RECOVERYOS_FULL = "RECOVERYOS_FULL"  # ML + Optimizer + Policy — NOT the AI diagnostician
    RECOVERYOS_AI = "RECOVERYOS_AI"  # ML + AI + Optimizer + Policy, on a bounded sample only
